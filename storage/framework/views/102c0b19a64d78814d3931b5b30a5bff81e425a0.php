...
<!-- <a href="<?php echo e(route('manager.newbussummary')); ?>" class="btn btn-outline-info mb-2"><i class="fa fa-plus" aria-hidden="true"></i> New</a> -->
<h3>Bus Summary</h3>
...
<?php echo $__env->make('layout/manager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Individual Assignment\assignment\resources\views/manager/bussummary.blade.php ENDPATH**/ ?>