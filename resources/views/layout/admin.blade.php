        ...
        <nav class=" d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link btn btn-info mb-2" href="{{route('admin.busesshedule')}}"><i class="fa fa-list-alt" aria-hidden="true"></i>
                Bus Schedule
                </a>
              </li>
              
              <li class="nav-item">
                <a class="nav-link btn btn-info mb-2" href="{{route('admin.bussummary')}}"><i class="fa fa-th-list" aria-hidden="true"></i>
                Bus Summary
                </a>
              </li>
             <!--  <li class="nav-item">
