      ...
      <!-- first row -->
        <div class="col-12 mb-2 bg-light">
          <nav class="navbar navbar-expand-lg navbar-light bg-light justify-content-end"> 
                ...
                <a class="btn btn-outline-info ml-2" href="{{route('manager.profile')}}">
                  Welcome,Rajon
                </a>
        ...
        <nav class=" d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link btn btn-info mb-2" href="{{route('manager.busesshedule')}}"><i class="fa fa-list-alt" aria-hidden="true"></i>
                Bus Schedule
                </a>
              </li>
              
              <li class="nav-item">
                <a class="nav-link btn btn-info mb-2" href="{{route('manager.bussummary')}}"><i class="fa fa-th-list" aria-hidden="true"></i>
                Bus Summary
                </a>
              </li>
             <!--  <li class="nav-item">
