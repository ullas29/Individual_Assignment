...
class managerController extends Controller
{
    ...
    public function busesshedule(Request $req)
    {
      $busesshedule = DB::table('busesshedule')
                    ->get();
      return view('manager/busesshedule',['busesshedule'=>$busesshedule]);
    ...
    public function bussummary(Request $req)
    {
      $bussummary = DB::table('bussummary')
                    ...
                    ->select('bussummary.*', 'busesshedule.name', 'busesshedule.route','busesshedule.operator','busesshedule.fare')
                       ...
                       ->get();
      return view('manager/bussummary',['bussummary'=>$bussummary]);
    }
...
// EDIT BUS SCHEDULE
    ...
    public function edit_busesshedule(Request $req,$id)
    {
      $busesshedule = DB::table('busesshedule')
                    ->where('bsid',$id)
                    ->first();
      return view('manager/edit_busesshedule',['busesshedule'=>$busesshedule]);
    } 
...
// EDIT BUS SCHEDULE
    ...
    if($validation->fails()){
        ...
        return redirect()->route('manager.editbusesshedule')
                        ->with('errors', $validation->errors())
                        ->withInput();
        }
            ...
            return redirect()->route('manager.busesshedule');
        }
    }
...
// ADD BUS SCHEDULE
    ...
    {
      return view('manager/new_busesshedule');
    }
    ...
    if($validation->fails()){
        ...
        return redirect()->route('manager.newbusesshedule')
                        ->with('errors', $validation->errors())
                        ->withInput();
        }
...
//bussummary
     ...
     public function edit_bussummary(Request $req,$id)
    {
      ...
      $bussummary = DB::table('bussummary')
                    ->get();
      return view('manager/edit_bussummary',['bussummary'=>$bussummary,'bussummary'=>$bussummary]);
    } 
